...
// khách. Màu chủ đạo qua biến --lc-primary (set từ theme); --lc-on-primary/--lc-primary-soft tính theo
// luminance trong ui.ts applyTheme() (story-07 AC2, WCAG contrast). Gọn, không phụ thuộc framework.
export const APP_CSS = `
:root{--lc-primary:#1677ff;--lc-on-primary:#fff;--lc-primary-soft:rgba(22,119,255,.12);--lc-bg:#fff;
  --lc-muted:#6b7280;--lc-line:#e5e7eb;--lc-in-bg:#f1f3f5}
...
.lc-header{background:var(--lc-primary);color:var(--lc-on-primary);padding:14px 16px;display:flex;
...
.lc-logo-fallback-solid{background:var(--lc-primary);color:var(--lc-on-primary)}
...
.lc-group-time{font-size:11px;color:var(--lc-muted);margin-top:3px}
.lc-group-time.lc-out{text-align:right}
...
.lc-field.lc-invalid input,.lc-field.lc-invalid textarea{border-color:#e5484d}
...
.lc-footer{flex:0 0 auto;height:28px;display:flex;align-items:center;justify-content:center;font-size:11px;
  color:var(--lc-muted);border-top:1px solid var(--lc-line);background:#fff}
